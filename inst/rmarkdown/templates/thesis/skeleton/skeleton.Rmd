...
# Originally created by Thomas Fung & Justin Wishart (MQ) (04 June 2018). 
# Updated by Thomas Fung (MQ) (21 Oct 2022) to follow the latest formating guideline.
author: 'Your Name'
date: 'May' # just need the month. Year will be added automatically. 
institution: 'Macquarie University' 
report_type: 'thesis' # is this a paper/report/thesis? 
division: "Examiner's Copy"
# replace above with " " if this is not an examiner's copy
department: 'School of Mathematical & Physical Sciences'
degree_or_unit: 'degree' # or 'unit'
degree_name_or_unit_no: 'Master of Research' # or 'STAT825'
notopenright: false #new chapter always opens on the right; to disable this, 
#   set this to true
title: 'Title: TBD'
...
# If your report type is not a thesis, you have to update the statement accordingly. 
# According to the MQ guidelines, you can also add in your Ethics Committee approval and protocol number here (if applicable).
acknowledgements: |
...
<!--
This is a part of the Rmarkdown thesis template for Statistics at Macquarie University (MQ). 
Created by Thomas Fung & Justin Wishart (MQ) (15 June 2018). 
Updated by Thomas Fung (MQ) (21 Oct 2022) to reflect the latest formating guidelines.
-->
<!--
